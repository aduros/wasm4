...
pub const PALETTE: *[4]u32 = @ptrFromInt(*[4]u32, 0x04);
pub const DRAW_COLORS: *u16 = @ptrFromInt(*u16, 0x14);
pub const GAMEPAD1: *const u8 = @ptrFromInt(*const u8, 0x16);
pub const GAMEPAD2: *const u8 = @ptrFromInt(*const u8, 0x17);
pub const GAMEPAD3: *const u8 = @ptrFromInt(*const u8, 0x18);
pub const GAMEPAD4: *const u8 = @ptrFromInt(*const u8, 0x19);
pub const MOUSE_X: *const i16 = @ptrFromInt(*const i16, 0x1a);
pub const MOUSE_Y: *const i16 = @ptrFromInt(*const i16, 0x1c);
pub const MOUSE_BUTTONS: *const u8 = @ptrFromInt(*const u8, 0x1e);
pub const SYSTEM_FLAGS: *u8 = @ptrFromInt(*u8, 0x1f);
pub const NETPLAY: *const u8 = @ptrFromInt(*const u8, 0x20);
pub const FRAMEBUFFER: *[6400]u8 = @ptrFromInt(*[6400]u8, 0xA0);
