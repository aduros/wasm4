...
# bunny
const bunnyWidth = 16
const bunnyHeight = 16
const bunnyFlags = BLIT_2BPP
var bunny: array[64, uint8] = [0xaa'u8,0x9e,0xac,0xaa,0xaa,0x57,0xbf,0x2a,0xaa,0x57,0xbf,0x2a,0xaa,0x17,0xbf,0x2a,0xaa,0x17,0x03,0x2a,0xaa,0x57,0x54,0x2a,0xa8,0x55,0x55,0x6a,0xa9,0x55,0x05,0x0a,0xaf,0xd5,0x55,0x4a,0xa8,0x75,0x55,0x4a,0xaa,0xd5,0x57,0x2a,0xaa,0x1d,0x7c,0xaa,0xa8,0x75,0x15,0x2a,0xa8,0x45,0x15,0x2a,0xaa,0x10,0x54,0xaa,0xaa,0x85,0x52,0xaa]
```
...
```nim
DRAW_COLORS[] = 0x2013
blit(addr bunny[0], 10, 10, bunnyWidth, bunnyHeight, bunnyFlags)
```
